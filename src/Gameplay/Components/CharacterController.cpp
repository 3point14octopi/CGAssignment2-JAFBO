...
void CharacterController::Update(float deltaTime) {
	xpos = InputEngine::GetKeyState(GLFW_KEY_S) == ButtonState::Down;
	xneg = InputEngine::GetKeyState(GLFW_KEY_W) == ButtonState::Down;
	ypos = InputEngine::GetKeyState(GLFW_KEY_D) == ButtonState::Down;
	yneg = InputEngine::GetKeyState(GLFW_KEY_A) == ButtonState::Down;
	zpos = InputEngine::GetKeyState(GLFW_KEY_UP) == ButtonState::Down;
	zneg = InputEngine::GetKeyState(GLFW_KEY_DOWN) == ButtonState::Down;
